...
from tensorflow.python.keras.layers import Input, Dense, Conv2D, MaxPooling2D, Dropout, Flatten, BatchNormalization

from constants import HEIGHT, WIDTH


class XyEMnistModelBN(BaseModel):
    def __init__(self, config):
        super(XyEMnistModelBN, self).__init__(config)
        self.build_model()
